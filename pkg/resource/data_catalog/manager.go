...
// +kubebuilder:rbac:groups=athena.services.k8s.aws,resources=datacatalogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=athena.services.k8s.aws,resources=datacatalogs/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"Parameters"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.Parameters != nil && latestKo.Spec.Parameters == nil {
		latestKo.Spec.Parameters = observedKo.Spec.Parameters
	}
